' ========================================================================================
' PsScrollPanel. Scrolling panel with an auto-hiding scrollbar
' ========================================================================================
...
#define APPNAME          wstr("Custom ScrollPanel")
#define APPCLASSNAME     wstr("custom_scrollpanel_class")
...
type THEME_TYPE
    ...
    BackColorEdit         as COLORREF = BGR(28,31,37)
